...
<body>
    <div class="container">
        <div class="text-center" style="margin: 20px 0px 20px 0px;">
            <a href="http://zvonar/admin/customer_phones" target="_blank">Список</a><br>
        ...
        <div class="clearfix">
            <div class="float-left">
                <form class="form-inline" action="{{url('admin/customer_phone/import')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
